<template>
  <div class="min-h-screen flex flex-col blossom-theme">
    ...
    <header class="fixed top-0 left-0 right-0 z-50" style="height:68px; background:rgba(255,255,255,0.95); backdrop-filter:blur(20px); -webkit-backdrop-filter:blur(20px); border-bottom:1px solid #FDD8EE;">
      <div class="h-full flex items-center justify-between" style="padding:0 72px;">
        ...
        <RouterLink to="/shop" class="flex items-center gap-3 no-underline group" style="text-decoration:none;">
          ...
          <div style="width:40px;height:40px;flex-shrink:0;">
            <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" width="40" height="40">
              <!-- Outer circle with soft pink dashes -->
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <div style="padding:12px 16px;border-bottom:1px solid #FDD8EE;background:#FFF5FA;">
                    <p style="font-family:'DM Sans',sans-serif;font-size:13px;font-weight:700;color:#3D1A2C;margin:0;">Nguyễn Kim</p>
                    <p style="font-family:'DM Sans',sans-serif;font-size:11px;color:#B07090;margin:2px 0 0;">kim@example.com</p>
                  </div>
    ...
    <!-- FOOTER -->
    <footer style="background:#FFFFFF; padding:64px 72px 32px; border-top:1px solid #FDD8EE;">
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:40px;margin-bottom:48px;" class="footer-grid">
      ...
      <!-- Bottom bar -->
      <div style="border-top:1px solid #FDD8EE;padding-top:24px;display:flex;justify-content:space-between;align-items:center;" class="footer-bottom">
...
const handleUserAction = (command) => {
  if (command === 'logout') {
    ...
    router.push('/shop/order-tracking')
  }
}
